...
private const val NAME = "utils.rateLimiters.MediaRequestRateLimiter"
...
class MediaRequestRateLimiter private constructor() :
    RequestRateLimiter(NAME, config) {
    companion object {
        @Volatile
        private var instance: MediaRequestRateLimiter? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: MediaRequestRateLimiter().also { instance = it }
            }
    }
}